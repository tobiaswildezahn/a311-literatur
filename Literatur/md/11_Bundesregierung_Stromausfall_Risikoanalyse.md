...
Aber wie hoch waren die Stromimporte nach Deutschland konkret? Dazu gibt die Strommarktdatenplattform der Bundesnetzagentur [SMARD.de](https://www.smard.de/page/home/topic-article/444/215556 "Externer Link: Internetwngebot der Bundesnetzagentur \(Öffnet im aktuellen Fenster\)") Auskunft: Im Jahr 2024 importierte Deutschland insgesamt 67,0 TWh und exportierte 35,1 TWh. Zum Vergleich: Insgesamt wurden in Deutschland 2024 netto 431,7 TWh Strom erzeugt.

## Was tut die Bundesregierung zur Sicherung der Energieversorgung?

Deutschland hat eines der sichersten Stromnetze der Welt – dank der **zahlreichen Sicherungsmechanismen.** Unter anderem stellt das „n -1-Prinzip“ sicher, dass das Stromnetz auch beim Ausfall einer Leitung weiterfunktioniert, weil der Strom auch auf einem anderen Weg fließen kann. Zudem gibt es Kraftwerke, die darauf ausgelegt sind, das Stromnetz im Notfall schnell wieder aufzubauen und hochzufahren

Wichtig für die Sicherheit der Energieversorgung ist es auch, die Stromproduktion sicher zu stellen und dafür einseitige Abhängigkeiten bei der Gasversorgung zu vermeiden. Das war eine der wichtigsten Lehren aus dem russischen Angriffskrieg auf die Ukraine, der in Deutschland wegen ausbleibender russischer Gaslieferungen eine Energiekrise zur Folge hatte. Auch aus diesem Grund hat sich Deutschland nicht nur beim Gas, sondern auch bei Kohle und Öl unabhängig von Lieferungen aus Russland gemacht. Deutschland bekommt stattdessen mehr Gas aus Norwegen und den Niederlanden sowie zusätzliche Flüssiggas-Importe über LNG-Terminals an Nord- und Ostsee. Zudem ist es gesetzlich geregelt, dass die Gasspeicher immer ausreichend gefüllt sein müssen. Dies wird kontinuierlich und tagesaktuell durch die [Bundesnetzagentur überwacht](https://www.bundesnetzagentur.de/DE/Fachthemen/ElektrizitaetundGas/Versorgungssicherheit/Strom/start.html "Externer Link: Die Bundesnetzagentur veröffentlicht in ihrem Lagebericht eine Einschätzung zur Gasversorgung. \(Öffnet im aktuellen Fenster\)").

Zur Energieunabhängigkeit und damit auch zur Versorgungssicherheit trägt zudem bei, dass der Anteil Erneuerbarer Energien stetig steigt. So wurden 2024 in Deutschland [59 Prozent des Stroms aus Erneuerbaren Energien](https://www.smard.de/page/home/topic-article/444/215556 "Externer Link: Internetwngebot der Bundesnetzagentur \(Öffnet im aktuellen Fenster\)") erzeugt (2023 waren es 56 Prozent). Diesen Ausbau der Erneuerbaren Energien will die Bundesregierung weiter beschleunigen.

Die Energieversorgung in Deutschland bleibt also eine der sichersten weltweit. Trotzdem ist es ebenso wichtig, dass wir Energie sparen und die Energieeffizienz stärken.
...
Das Bundesamt für Bevölkerungsschutz und Katastrophenhilfe informiert dazu, wie die [Auswirkungen eines Stromausfalls gemildert werden](https://www.bbk.bund.de/DE/Warnung-Vorsorge/Tipps-Notsituationen/Stromausfall/stromausfall_node.html "Externer Link: Das Bundesamt für Bevölkerungsschutz und Katastrophenhilfe informiert, wie man für Stromausfälle vorsorgt \(Öffnet neues Fenster\)") können.
...
Aus kurzfristig und vorübergehend hohen Preisen lassen sich auch keine Rückschlüsse auf die Versorgungssicherheit treffen. Die ist in Deutschland weiter **auf einem**[**sehr hohen****Niveau**](https://www.bundesnetzagentur.de/SharedDocs/Pressemitteilungen/DE/2024/20241111_SAIDI_Strom.html?nn=659670 "Externer Link: https://www.bundesnetzagentur.de/SharedDocs/Pressemitteilungen/DE/2024/20241111_SAIDI_Strom.html?nn=659670 \(Öffnet im aktuellen Fenster\)") – auch im internationalen Vergleich.

Einen detaillierten, tagesaktuellen Blick auf Stromerzeugung, -verbrauch, Großhandelspreise sowie den grenzüberschreitenden Stromhandel ermöglicht [SMARD ](https://www.smard.de/home "Externer Link: https://www.smard.de/home \(Öffnet im aktuellen Fenster\)")\- die Informationsplattform der Bundesnetzagentur über den deutschen Strommarkt.
  *[TWh]: Terawattstunden
