...
Plötzlich ist es dunkel. Der Fernseher geht aus, die Heizung funktioniert nicht mehr und das Handy wird nicht mehr geladen. [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md). Für wenige Minuten kein Problem, doch ein großflächiger und anhaltender [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md), Blackout genannt, kann katastrophale Auswirkungen haben. Was kann einen Blackout auslösen? Wie wahrscheinlich ist so ein Ereignis in Deutschland und was tun Energieunternehmen, um das zu verhindern?

|  0

Das Wichtigste in Kürze

  * Ein Blackout ist ein großflächiger, unkontrollierter und über Tage anhaltender [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md) mit gravierenden Folgen für den Alltag, die Wirtschaft und die kritische Infrastruktur.
  ...
  * Dafür sorgen hohe Auflagen, die an die Sicherheit der Stromnetze gestellt werden. Unter anderem müssen sie nach dem n-1-Prinzip errichtet sein: erst wenn das zweite Bauteil im Netz ausfällt, kommt es zum [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md).
...
Ein echter Blackout ist laut [Bundesnetzagentur](https://www.bundesnetzagentur.de/DE/Allgemeines/DieBundesnetzagentur/Insight/Texte/Energiewende/Blog17_Energiewende_Blackout.html) ein unkontrollierter und unvorhergesehener Ausfall, bei dem mindestens größere Teile des europäischen Stromnetzes ausfallen. Er zeichnet sich durch folgende Kriterien aus:
  ...
  * **Kritische Auswirkungen:** Die Dauer und Intensität führen zu massiven Einschnitten im öffentlichen Leben sowie zu schweren wirtschaftlichen Schäden. Wenn das [Stromnetz](/unternehmen/themen/netze/das-europaeische-stromnetz.html) ausfällt, können auch andere öffentliche Netze wie die Gasversorgung oder das Telekommunikationsnetz betroffen sein.

Bild herunterladen

### Blackout, Brownout und Stromausfall – Wo ist der Unterschied?

In der öffentlichen Debatte werden die Begriffe [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md), Blackout und Brownout oft vermischt. Für die Einordnung der Versorgungssicherheit ist eine präzise Unterscheidung jedoch entscheidend:

  * **[[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md):** Eine lokal begrenzte Störung bzw. Unterbrechung der Stromversorgung, die meist durch punktuelle technische Defekte oder Wetterereignisse ausgelöst und schnell durch Reparaturen oder Umschaltungen im örtlichen Netz behoben wird.
  * **[Brownout](/unternehmen/themen/netze/brownout.html) (Kontrollierte Abschaltung):** Eine gezielte und zeitlich begrenzte Abschaltung bestimmter Regionen durch die Netzbetreiber mit dem Ziel, das Gesamtnetz zu entlasten. Im Notfall kann der Brownout als aktives Werkzeug des Krisenmanagements dienen, um einen echten Blackout zu verhindern.
...
|  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  |  Brownout  |  Blackout
---|---|---|---
**Charakter** |  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  Lokale Störung im Verteilnetz.  |  Brownout  Gezielte Maßnahme zur Netzstabilisierung.  |  Blackout  Totaler Zusammenbruch des Verbundnetzes.
**Reichweite** |  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  Sehr begrenzt (Haus, Straße, Stadtteil).  |  Brownout  Regional begrenzt auf Teilgebiete.  |  Blackout  Großflächig (überregional bis länderübergreifend).
**Dauer** |  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  Kurz (Minuten bis wenige Stunden).  |  Brownout  Kurzfristig (meist rollierend über wenige Stunden).  |  Blackout  Langfristig (Stunden bis mehrere Tage).
**Ursache** |  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  Defekte (z.B. Baggerbiss), lokales Unwetter oder technischer Fehler im Trafo.  |  Brownout  Drohender Strommangel, Erzeugungsüberschuss oder Netzüberlastung.  |  Blackout  Extremwetter, Kaskadeneffekte, technisches Versagen oder [Sabotage](46_BBK_Sabotage.md).
**Wiederherstellung** |  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  Einfache Reparatur oder Umschaltung vor Ort.  |  Brownout  Manuelle oder automatisierte Zuschaltung der Last.  |  Blackout  Komplexer Netzwiederaufbau („Schwarzstart“ von Kraftwerken).
**Wahrscheinlichkeit** |  Klassischer [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md)  Regelmäßig (Teil des normalen Netzbetriebs).  |  Brownout  Gestiegen (aufgrund angespannter Versorgungslagen).  |  Blackout  Sehr gering (dank mehrstufiger Schutzsysteme).
...
### Das Prinzip der Netzüberlastung

Auch aufgrund einer Netzüberlastung kann es zu einem [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md) kommen. (Bild: Adobe Stock)
...
Beim Anzeigen des Videos werden Daten an YouTube übertragen. Erst wenn Sie den Button anklicken, wird das YouTube-Video angezeigt. Bitte beachten Sie die Datenschutzhinweise von [YouTube](https://policies.google.com/privacy).

Zu den [primären Ursachen eines Blackouts](https://www.akademienunion.de/fileadmin/au-uploads/publikationen/Publikationen_PDFs/2023/ESYS_Impuls_Blackouts.pdf) zählen:
  ...
  * **Gezielte Angriffe:** [Sabotage](46_BBK_Sabotage.md), terroristische Akte oder Cyberattacken auf die digitale Steuerungsinfrastruktur. Ein lückenloser Schutz ist angesichts der enormen Netzausdehnung faktisch nicht möglich.
...
### Fallbeispiel: Der großflächige Stromausfall in Berlin

Technisch gesehen kein Blackout: Der [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md) in Berlin Anfang 2026 (Symbolbild: Adobe Stock)

Der [Vorfall im Südwesten Berlins im Januar 2026](https://www.tagesschau.de/inland/gesellschaft/stromausfall-berlin-lehren-100.html) verdeutlichte die Verwundbarkeit lokaler Infrastrukturknotenpunkte. Infolge eines Brandanschlags auf eine Kabelbrücke wurde eine zentrale Versorgungsleitung massiv beschädigt. Rund 100.000 Haushalte waren über mehrere Tage von der Strom-, Heizungs- und Warmwasserversorgung abgeschnitten.

Obwohl die Medien häufig den Begriff „Blackout“ verwendeten, handelte es sich technisch um einen lokal begrenzten, gravierenden [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md). Da die Störung auf die Beschädigung physischer Leitungen an einem spezifischen Punkt zurückzuführen war und das europäische Verbundnetz stabil blieb, konnte die Versorgung durch aufwendige Reparaturmaßnahmen wiederhergestellt werden. Der Vorfall unterstreicht jedoch die Notwendigkeit einer erhöhten Resilienz gegenüber gezielter [Sabotage](46_BBK_Sabotage.md) an kritischen Leitungswegen.

## Wie wahrscheinlich ist ein Blackout in Deutschland?

Laut [Bundesnetzagentur](https://www.bundesnetzagentur.de/SharedDocs/Pressemitteilungen/DE/2025/20251009_Saidi_Strom.html) ist ein flächendeckender [[Stromausfall](74_BBK_Stromausfall_Detail.md)](73_BBK_Stromausfall_Themenseite.md) in Deutschland “äußerst unwahrscheinlich“. Aktuelle Erhebungen zur Versorgungsqualität bestätigen regelmäßig, dass das deutsche Stromnetz eines der zuverlässigsten weltweit ist. Auch das [Bundesamt für Bevölkerungsschutz und Katastrophenhilfe](https://www.bbk.bund.de/DE/Themen/Kritische-Infrastrukturen/KRITIS-Gefahrenlagen/Stromausfall/stromausfall.html) (BBK) betont das hohe Sicherheitsniveau der deutschen [kritischen Infrastruktur](/unternehmen/themen/digitalisierung/schutz-kritischer-infrastruktur.html).

Bild herunterladen

Die Robustheit des Netzes basiert auf mehreren Säulen:
...
*SAIDI (System Average Interruption Duration Index); Quelle: VDE FNN, Stand 2026
...
Bild herunterladen
  ...
  * **Finanzielle Folgen:** Die finanziellen Schäden eines solchen Ereignisses sind immens. Eine grundlegende Analyse des [Büros für Technikfolgen-Abschätzung beim Deutschen Bundestag](https://www.itas.kit.edu/pub/v/2011/peua11a.pdf) (TAB) beziffert die Kosten eines deutschlandweiten Blackouts auf bis zu 1,3 Milliarden Euro pro Stunde.
...
### Prävention: Stabilität im Normalbetrieb
...
Grundlage der Netzsicherheit ist das permanente Gleichgewicht zwischen Stromerzeugung und -verbrauch. Um dieses zu gewährleisten, nutzen Netzbetreiber folgende Instrumente:
  ...
  * **[Redispatch](/unternehmen/themen/netze/redispatch.html):** Droht eine Überlastung einzelner Leitungen, weisen Netzbetreiber [Kraftwerke](/unternehmen/themen/kohleausstieg/kraftwerke.html) an, ihre Einspeisung gezielt anzupassen (zu drosseln oder zu erhöhen), um den Lastfluss im Netz zu steuern.
  * **[Regelenergie](/unternehmen/themen/netze/regelenergie.html):** Zum Ausgleich kurzfristiger, unvorhergesehener Schwankungen (z. B. durch wechselnde Windverhältnisse) steht Regelenergie bereit, die innerhalb von Sekunden oder Minuten aktiviert wird.
  ...
  * **Digitalisierung & [Smart Grids](/unternehmen/themen/netze/smart-grid.html):** Durch die Digitalisierung der Infrastruktur können Netzbetreiber dezentrale Anlagen gezielter steuern. Diese vernetzte Intelligenz fängt Schwankungen direkt an der Entstehung ab und stärkt die Resilienz des Gesamtsystems.

Bild herunterladen

### Krisenmanagement: Reaktion bei kritischen Störungen
...
Sollte das Netz trotz aller Präventivmaßnahmen an seine Grenzen stoßen, greifen abgestufte Notfallkonzepte, um einen unkontrollierten Blackout zu verhindern:
  ...
  * **Gezielte Lastabwürfe ([Brownouts](/unternehmen/themen/netze/brownout.html)):** Als letztes technisches Mittel können regionale, rollierende Abschaltungen vorgenommen werden. Diese kontrollierten Eingriffe entlasten das System sofort und verhindern einen unkontrollierten Totalausfall.
...
### Gesetzlicher Schutzrahmen: Das KRITIS-Dachgesetz

Ergänzend zur technischen Vorsorge ist im Januar 2026 das neue [KRITIS-Dachgesetz](https://www.bundestag.de/dokumente/textarchiv/2026/kw05-de-kritische-infrastruktur-1137002) in Kraft getreten. Es bildet erstmals einen sektorenübergreifenden gesetzlichen Rahmen, um die Resilienz kritischer Anlagen weit über den reinen Stromsektor hinaus zu stärken. Betreiber müssen seitdem noch strengere Mindeststandards bei der physischen und digitalen Absicherung nachweisen, was die Widerstandsfähigkeit des Gesamtsystems gegenüber [Sabotage](46_BBK_Sabotage.md) oder Extremwetter (z.B. [Hochwasser](/unternehmen/themen/klimaschutz/hochwasserschutz.html)) weiter erhöht.

## Kann ein Blackout im europäischen Ausland zu Netzschwankungen in Deutschland führen?

Bild herunterladen

Als Mitglied im europäischen Verbundnetz ist Deutschland Teil eines großen Netzwerks. (Bild: transnet bw)

Stromtechnisch gesehen ist Europa ein großes, miteinander verwobenes Netzwerk. Dieses Netzwerk nennt man das [europäische Verbundnetz](/unternehmen/themen/netze/das-europaeische-stromnetz.html). Jedes Land, das zu diesem Netz gehört, ist wie ein Knotenpunkt in diesem riesigen Netzwerk. Das bedeutet, dass die Länder nicht isoliert voneinander arbeiten, sondern eng miteinander verbunden sind. Wenn es also in einem Land zu einem Problem kommt, wie beispielsweise einem plötzlichen Blackout könnten die Auswirkungen theoretisch bis nach Deutschland spürbar sein. Aber: Größer als das Risiko sind eindeutig die Chancen dieses großen Netzwerks. Denn darin lassen sich leichter Störungen auffangen und ausgleichen. Daher ist es nicht nur wichtig, dass jedes einzelne Land sein eigenes [Stromnetz](/unternehmen/themen/netze/stromnetze-so-kommt-der-strom-in-die-steckdose.html) stabil hält, sondern auch, dass die Länder gemeinsam daran arbeiten, das gesamte europäische Netz stabil und sicher zu halten.
...
[Netze](https://www.enbw.com/unternehmen/themen/netze/)
...
Bitte beachten Sie die Datenschutzhinweise von [YouTube](https://policies.google.com/privacy).

Bild herunterladen

[Zur ECO*Journal Übersicht](/unternehmen/eco-journal/)