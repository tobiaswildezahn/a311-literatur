...
[Bild: graph of the 14 megatrends shaping our world]

The 14 megatrends are:
...
The EU should also continue to further develop tools such as [_rescEU_](https://civil-protection-humanitarian-aid.ec.europa.eu/what/civil-protection/resceu_en), programmes like the [Copernicus Emergency Management Service](https://emergency.copernicus.eu/) and tools like the [_Risk Data Hub_](https://drmkc.jrc.ec.europa.eu/risk-data-hub).
...
The [_Disaster Risk Management Knowledge Centre_](https://drmkc.jrc.ec.europa.eu/) and the [_Union Civil Protection Knowledge Network_](https://civil-protection-knowledge-network.europa.eu/) are European initiatives aimed at facilitating evidence-based decision-making through knowledge management and analytical tools. They form a robust framework to enhance the EU’s capabilities for addressing risks, ensuring that civil protection policies and practices across the EU are informed by the latest scientific knowledge and promoting cooperation, innovation, improved anticipation, prevention and effective response to disasters.

This report addresses the evolution of the EU Legislative Framework, promoting proactive disaster risk management for cross-border and emerging risks. It aims to support Article 6 of the [_Union Civil Protection Mechanism (UCPM)_](https://civil-protection-humanitarian-aid.ec.europa.eu/what/civil-protection/eu-civil-protection-mechanism_en) in its objective to promote an effective and coherent approach to the prevention of and preparedness for disasters. Through the collection of scientific contributions from experts within the JRC, the report can complement the assessment of risks conducted by Member States.
...
JRC portfolios 2025-27
  ...
  * [Anticipation, risks, resilience](/node/10132_en)
