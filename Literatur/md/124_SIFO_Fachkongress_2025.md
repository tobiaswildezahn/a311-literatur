...
[Bild: bbk-kongress 2025]

3 Tage, 55 Sessions und Podiumsdiskussionen, 900 Fachbesucherinnen und -besucher: So lautet die Bilanz des zweiten [Fachkongresses „Forschung für den Bevölkerungsschutz“](https://www.fkfb.de "Externer Link https://www.fkfb.de/"),**** der von******5\. bis 7. Februar 2025** im [World Conference Center Bonn](https://www.worldccbonn.com/index.php?id=1 "Externer Link Zur Webseite des WCCB \(Öffnet neues Fenster\)") stattgefunden hat. Auf dem Kongress, der vom Bundesamt für Bevölkerungsschutz und Katastrophenhilfe (BBK) ausgerichtet wurde, war das BMBF im Rahmen des Programms „[Forschung für die zivile Sicherheit](sifo/de/programm/programm_node.html "Programm  \(Öffnet neues Fenster\)")“ mit einem eigenen Stand dabei. Zudem präsentierten über **20 Projekte aus der zivilen Sicherheitsforschung** ihre Ergebnisse in den zahlreichen Fachsessions.
...
Auch die Mitglieder des [Graduierten-Netzwerks „Zivile Sicherheit“](sifo/de/programm/graduierten-netzwerk-zivile-sicherheit/graduierten-netzwerk-zivile-sicherheit_node.html "Graduierten-Netzwerk "Zivile Sicherheit"   \(Öffnet neues Fenster\)") tauschten sich in einer Session zum Thema „**Integrierte Sicherheit – Werden wir dem Anspruch gerecht?** “ aus. Dabei wurden von den Teilnehmenden aus der Perspektive der Forschung und Anwenderpraxis die vielfältigen Aspekte und Anforderungen des integrierten Sicherheitsbegriffs beleuchtet.
...
[ Telemedizinische Untersuchungskabine zur Sicherstellung der ärztlichen Grundversorgung (KABINE)](/sifo/shareddocs/Downloads/P-Umrisse/projektumriss_kabine.pdf?__blob=publicationFile&v=1 "Telemedizinische Untersuchungskabine zur Sicherstellung der ärztlichen Grundversorgung \(KABINE\)")
...
[ Digitale Dynamische Patienten- und Lagesimulation (D2PuLs-PRO)](/sifo/shareddocs/Downloads/P-Umrisse/projektumriss_d2puls_pro.pdf?__blob=publicationFile&v=1 "Digitale Dynamische Patienten- und Lagesimulation \(D2PuLs-PRO\)")
...
[Begleitforschungsprojekt SifoLIFE - Effektiv und nachhaltig in die Praxis (BeLIFE)](sifo/de/projekte/querschnittsthemen-und-aktivitaeten/sifolife/belife/belife_node.html "BeLIFE  \(Öffnet neues Fenster\)")
...
Mit am BeLIFE-Stand war das SifoLIFE-Projekt „[Dynamische Lageerstellung und Unterstützung für Rettungskräfte in komplexen Krisensituationen mittels Datenfusion und intelligenten Drohnenschwärmen (RESCUE-MATE)](sifo/de/projekte/querschnittsthemen-und-aktivitaeten/sifolife/rescue-mate-hansestadt-hamburg/rescue-mate-hansestadt-hamburg_node.html "RESCUE-MATE \(Hansestadt Hamburg\) \(Öffnet neues Fenster\)")“, welches eine virtuelle 3D-Simulation von einem ansteigenden Hochwasser im Hamburger Hafen präsentierte. So können Hochwasserschutzmaßnahmen genauer geplant und umgesetzt werden.

[Mobile Digitale Vorbereitung und Reaktion ohne Grenzen (DigiPREW)](SiteGlobals/Functions/KurzURLs/sifo/digiprew.html?nn=1080508 "digiprew \(Öffnet neues Fenster\)")
...
[B-PREPARED, Horizon Europe Projekt](https://b-prepared-project.com "Externer Link B-Prepared Webseite \(Öffnet neues Fenster\)")
...
Weitere Informationen zum Fachkongress „Forschung für den Bevölkerungsschutz“ finden Sie **[HIER](https://www.fkfb.de "Externer Link https://www.fkfb.de/ \(Öffnet neues Fenster\)")**.
