...
| behoerden-spiegel.de | 14 | 115, 301, 305, 310, 311, 312, 320, 325, 327, 336... |
...
| civil-protection-humanitarian-aid.ec.europa.eu | 7 | 245, 246, 262, 288, 30, 33, 390 |
...
| 385 | BehoerdenSpiegel_Pakt_Bevoelkerungsschutz | journalistisch | Behörden Spiegel | 2026 | mittel |
| 386 | SPD_Fraktion_HH | primaer | SPD-Fraktion Hamburgische Bürgerschaft | 2023 | hoch |
| 387 | RadioHamburg_Bevoelkerungsschutz_Umbau | journalistisch | Radio Hamburg | 2024 | niedrig |
...
- 386: SPD_Fraktion_HH (primaer)
- 388: BfV_VSW_Sicherheitstagung (primaer)
...
```mermaid
graph LR
    D04["04: BMVg_PM_Gesamtverteidigung<br/>PRI | 5 URLs"]
    D05["05: KZV_2016_Info<br/>PRI | 3 URLs"]
    D06["06: BT_Risikoanalyse_Zivilschutz<br/>PRI | 2 URLs"]
    D07["07: BT_Risikoanalyse_Chemische<br/>PRI | 2 URLs"]
    D08["08: BBK_Risikoanalysen_Uebersicht<br/>PRI | 7 URLs"]
    D100["100: Wikipedia_Hochwasser_Sueddeutschland<br/>TER | 80 URLs"]
    D101["101: BBK_Hochwasser_Niedersachsen<br/>GRA | 5 URLs"]
    D102["102: UFZ_Hochwasser_Sueddeutschland<br/>SEK | 43 URLs"]
    D103["103: UBA_Hitzemortalitaet<br/>PRI | 3 URLs"]
    ...
    D115["115: Behoerden_Spiegel_LUEKEX<br/>JOU | 12 URLs"]
    D116["116: Finanznachrichten_LUEKEX_2026<br/>JOU | 8 URLs"]
    D120["120: VATM_Cell_Broadcast<br/>GRA | 6 URLs"]
    D124["124: SIFO_Fachkongress_2025<br/>GRA | 4 URLs"]
    ...
    D151["151: GMF_NATO_Societal<br/>GRA | 1 URLs"]
    ...
    D20["20: RadioHH_Bevoelkerungsschutz_Umbau<br/>JOU | 2 URLs"]
    ...
    D241["241: Boell_Quis_Comprehensive<br/>SEK | 1 URLs"]
    ...
    D303["303: OPLAN_Reservistenverband_Dienstjahr<br/>GRA | 1 URLs"]
    ...
    D336["336: Pakt_Bevoelkerungsschutz<br/>JOU | 1 URLs"]
    ...
    D373["373: BT_Drs_21<br/>PRI | 13 URLs"]
    D375["375: BMG_Roadmap_Hitzeschutz<br/>PRI | 36 URLs"]
    D376["376: CIMIC_COE_Resilience<br/>GRA | 17 URLs"]
    D38["38: MWI_Beyond_Ends<br/>SEK | 15 URLs"]
    D385["385: BehoerdenSpiegel_Pakt_Bevoelkerungsschutz<br/>JOU | 1 URLs"]
    D387["387: RadioHamburg_Bevoelkerungsschutz_Umbau<br/>JOU | 1 URLs"]
    ...
    D50["50: Bayern_Hybride_Bedrohungen<br/>GRA | 19 URLs"]
    D58["58: Behoerden_Spiegel_Gesamtverteidigung<br/>JOU | 12 URLs"]
    D59["59: Reservistenverband_Gesamtverteidigung<br/>JOU | 4 URLs"]
    D60["60: Wikipedia_OPLAN_Deutschland<br/>TER | 13 URLs"]
    D62["62: Correctiv_Bundeswehr_Kriegstuechtigkeit<br/>JOU | 9 URLs"]
    D65["65: DGAP_Zeitenwende_Zivile<br/>SEK | 19 URLs"]
    ...
    D80 -->|1| D91
    D95 -->|1| D96
    style D04,D05,D06,D07,D08,D103,D104,D11,D14,D141,D15,D200,D255,D267,D269,D272,D273,D298,D373,D375,D96 fill:#2563eb,color:#fff
    ...
    style D101,D106,D108,D120,D124,D148,D151,D17,D24,D266,D30,D303,D31,D349,D376,D50,D73,D74,D76,D79,D95 fill:#d97706,color:#fff
    style D110,D115,D116,D20,D275,D305,D320,D321,D336,D338,D370,D385,D387,D48,D49,D58,D59,D62,D80,D87,D91,D93,D94 fill:#059669,color:#fff
